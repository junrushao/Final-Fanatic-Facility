...
import Compiler2015.IR.Instruction.ThreeAddressInstruction.DivideReg;
...
public class Divide extends BinaryExpression {
	...
	public static Expression getExpression(Expression a1, Expression a2) {
		...
		if (v1 != null && v2 != null) {
			if (v2 == 0)
				throw new CompilationError("Division by 0.");
	...
	public void emitCFG(ExpressionCFGBuilder builder) {
		...
		builder.addInstruction(DivideReg.getExpression((VirtualRegister) tempRegister, left.tempRegister, right.tempRegister));
	}
