...
import Compiler2015.IR.Instruction.ThreeAddressInstruction.SetEqualTo;
...
public class EqualTo extends BinaryExpression {
	...
	public void emitCFG(ExpressionCFGBuilder builder) {
		...
		builder.addInstruction(SetEqualTo.getExpression((VirtualRegister) tempRegister, left.tempRegister, right.tempRegister));
	}
