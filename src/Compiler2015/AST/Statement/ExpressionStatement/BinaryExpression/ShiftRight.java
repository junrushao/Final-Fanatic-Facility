...
import Compiler2015.IR.Instruction.Arithmetic.ShiftRightReg;
...
public class ShiftRight extends BinaryExpression {
	...
	public void emitCFG(ExpressionCFGBuilder builder) {
		...
		builder.addInstruction(new ShiftRightReg(tempRegister, left.tempRegister, right.tempRegister));
	}
}
