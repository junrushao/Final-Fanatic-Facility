...
import Compiler2015.IR.Instruction.ThreeAddressInstruction.BitwiseOrReg;
...
public class BitwiseOr extends BinaryExpression {
	...
	public void emitCFG(ExpressionCFGBuilder builder) {
		...
		builder.addInstruction(BitwiseOrReg.getExpression((VirtualRegister) tempRegister, left.tempRegister, right.tempRegister));
	}
