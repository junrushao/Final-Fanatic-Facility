...
import Compiler2015.IR.Instruction.ThreeAddressInstruction.ShiftLeftReg;
...
public class ShiftLeft extends BinaryExpression {
	...
	public void emitCFG(ExpressionCFGBuilder builder) {
		...
		builder.addInstruction(ShiftLeftReg.getExpression((VirtualRegister) tempRegister, left.tempRegister, right.tempRegister));
	}

	@Override
	public Expression rebuild() {
		return new ShiftLeft(left.rebuild(), right.rebuild());
	}
}
