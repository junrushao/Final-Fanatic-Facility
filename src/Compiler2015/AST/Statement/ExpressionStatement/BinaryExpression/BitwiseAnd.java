...
import Compiler2015.IR.Instruction.ThreeAddressInstruction.BitwiseAndReg;
...
public class BitwiseAnd extends BinaryExpression {
	...
	public void emitCFG(ExpressionCFGBuilder builder) {
		...
		builder.addInstruction(BitwiseAndReg.getExpression((VirtualRegister) tempRegister, left.tempRegister, right.tempRegister));
	}
