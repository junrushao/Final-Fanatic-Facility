 ...
 * rd = rs != rt
 */
public class SetNotEqual extends ThreeAddressInstruction {

	public SetNotEqual(VirtualRegister rd, IRRegister rs, IRRegister rt) {
		this.rd = rd.clone();
		this.rs = rs.clone();
		this.rt = rt.clone();
	}
	...
	public static IRInstruction getExpression(VirtualRegister rd, IRRegister rs, IRRegister rt) {
		...
		return new SetNotEqual(rd, rs, rt);
	}
